...
// Change a string to a vector<string> of 1 element
std::vector<std::string> string_to_vector(const std::string& id);

const std::string NONE = "None";
// Print none if the variable is false
void print_none(bool& is_any);
}
#endif // UTILS_HH
