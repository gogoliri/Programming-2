...
int main() {
    ...
    while ( true ) {
        ...
        if(command_to_be_executed != "+"
                and command_to_be_executed != "-"
                and command_to_be_executed != "/"
                and command_to_be_executed != "*"
                and command_to_be_executed != "^"){
            change_to_upper(command_to_be_executed);
        }
        ...
        if(is_exit==true){
            ...
            if(string_to_double(pieces.at(1), left)
                    and string_to_double(pieces.at(2), right)){
                double result = func(left, right);
                cout<<result<<endl;
            }else{
